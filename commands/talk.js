...
module.exports = {
	name: "talk",
	description: "Have the bot verbally abuse you! (unless ur Fvn)",
	cooldown: 1,
	execute(message, args) {
		...
		var responsesFvn = ["lol why u talk to me", "creating me was a mistake lol", "you were too lazy to make more than 3 responses for yourself lmao nice"];
		if (message.author.id === config.misc.owner) return message.channel.send(responsesFvn[Math.floor(Math.random() * responses.length)]);
